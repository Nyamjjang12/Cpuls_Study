...
int main()
{
	...
	*/
	...
	intValue5 가 1증가된 상태에서 intValue6에 들어갑니다.
	따라서 intValue5도 11이되고, intValue6도 11이됩니다.
	*/
	intValue6 = ++intValue5;
	...
	*/
	...
	foreach문의 장점이자 단점은 한번 실행하면 끝까지 실행한다는 점 입니다.
	...
	*/
	...
	조건식은 bool 형태 이어야 합니다. 반복 실행 코드가 2줄 이상이면 블록으로 지정하면 됩니다.
   ...
   */
	...
	*/
	...
	하지만 중간에 if (sum > 5) break를 통해서 반복문을 빠져나가도록 해 봅니다.
	...
	이렇게 4회를 돌고 sum의 결과 값이 6이 되었을 때 if(sum > 5) 를 만족하게 되어 break가 걸리게 됩니다.
