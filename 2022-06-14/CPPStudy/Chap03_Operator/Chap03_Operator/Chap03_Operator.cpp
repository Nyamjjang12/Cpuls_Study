...
int main()
{
	...
	*/
	...
	따라서 intValue5도 11이되고, intValue6도 11이 됩니다.
	*/
	intValue6 = ++intValue5;
	...
	*/
	...
	/**
	관계 연산자(Relateional Operrator, 비교 연산자)에 대해서 알아 봅니다.
	C++에는 여섯 가지의 관계 연산자가 있습니다.
	관계 연산자는 boolean타입으로 true(1) 또는 false(0)값을 반환합니다.
	...
	*/
	...
	!	: Logical Not 부정입니다. 값이 참이면 거짓이 되고, 값이 거직이면 참이 됩니다.
	...
	*/
	...
	/**
	intValue9변수의 값이 1보다 크거나 같고 intValue9변수의 값이 10보다 작거나 같다
	...
	*/
	...
	삼항연산자
	조건 ? A문장 : B문장 조건에 맞으면 A 문장이 실행되고, 조건에 맞지 않으면 B 문장이 실행됩니다,
	*/
	cout << "boolValue1 : " << (boolValue1 ? "True" : "false") << endl;
	cout << "boolValue2 : " << (boolValue2 ? "True" : "false") << endl;
	cout << "boolValue3 : " << (boolValue3 ? "True" : "false") << endl;
	...
	*/
	...
	30 + 2 * 3의 결과 값은 무엇일까요? 36일까요? 96일까요?
	...
	*/
	...
	/**
	나는 96의 값을 생각 하고 코딩을 하고 있는데 36이 나옵니다. 버그입니다. 어떻게 해야 할까요?
	*/
	intValue10 = (30 + 2) * 3;
	cout << "(30 + 2) * 3 : " << intValue10 << endl;
	cout << "" << endl;
